...
export default function Index({ productos, resumen, umbral, filters }) {
    ...
    function handleAjuste(e) {
        ...
        setProcessing(true);
        router.patch(
            `/inventario/${ajusteModal.id}/ajustar`,
            {
                tipo: ajusteTipo,
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-bold text-gray-900">
                                        {formatPrice(resumen.valor_inventario)}
                                    </p>
                                </div>
                            </div>
                        </CardContent>
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                applyFilters({ umbral: e.target.value })
                            }
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b border-gray-200 bg-gray-50">
                                    ...
                                    <th className="hidden px-4 py-3 font-medium text-left text-gray-600 md:table-cell">
                                        Categoría
                                    </th>
                                    <th className="hidden px-4 py-3 font-medium text-right text-gray-600 sm:table-cell">
                                        Precio
                                    </th>
                                    <th className="w-32 px-4 py-3 font-medium text-center text-gray-600">
                                        Stock
                                    </th>
                                    ...
                                    {can("productos.editar") && (
                                        <th className="w-24 px-4 py-3 font-medium text-center text-gray-600">
                                            Ajustar
                                        </th>
                                    )}
                                </tr>
                ...
                <div className="fixed inset-0 z-[200] flex items-center justify-center">
                    ...
                    <div className="relative w-full max-w-sm p-6 mx-4 bg-white rounded-lg shadow-xl">
                        ...
                        <p className="mb-4 text-sm text-gray-500">
                            {ajusteModal.nombre} — Stock actual:{" "}
                        ...
                        <form onSubmit={handleAjuste} className="space-y-4">
                            ...
                            <div className="flex justify-end gap-3 pt-2">
                                ...
                                <Button
                                    type="submit"
                                    disabled={!ajusteCantidad || processing}
                                >
