...
return [
    ...
    'title' => config('Chivo Pedidos Documentacion').' API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API REST para el sistema de gestión de pedidos. Autenticación mediante tokens con Laravel Sanctum.',
    ...
    'auth' => [
        ...
        'use_value' => env('1|WZLUKQNQ9Td2p46nzBHTnkJfjhTl1NRiY23cz1ZDdc72309b'),
